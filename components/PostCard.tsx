...
const QAItemCard: React.FC<QAItemCardProps> = ({ item, index }) => {
  ...
  return (
    <div className="bg-white border border-[#E8DCC6] rounded-2xl p-8 md:p-10 shadow-sm hover:shadow-md transition-all relative overflow-hidden group">
      {/* Accent Bar */}
      <div className="absolute top-0 left-0 w-2 h-full bg-[#DD8B8B]" />
      
      <div className="flex flex-col gap-8 pl-4">
        {/* Topic Badge */}
        <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-[#DD8B8B]/10 flex items-center justify-center shrink-0">
                <HelpCircle className="text-[#DD8B8B]" size={22} />
            </div>
            <span className="px-4 py-1.5 bg-[#DD8B8B] text-white text-base font-bold rounded-full shadow-sm tracking-wide">
                {item.topic}
            </span>
        </div>
        ...
        <div className="flex flex-col gap-6">
            {item.questions.map((question, qIdx) => (
                <div key={qIdx} className="relative pl-8 before:content-[''] before:absolute before:left-1 before:top-4 before:w-2.5 before:h-2.5 before:bg-[#734025] before:rounded-full">
        ...
        <div className="ml-0 md:ml-12 mt-4">
           <div className="relative">
             ...
             <textarea 
                ...
                className="w-full min-h-[160px] p-5 pl-14 bg-[#FDFBF7] border-2 border-[#E8DCC6] rounded-xl text-lg md:text-xl 2xl:text-2xl text-[#4A2C2A] placeholder:text-[#BCAAA4] focus:outline-none focus:border-[#DD8B8B]/50 focus:bg-white transition-all resize-y font-serif leading-relaxed"
             />
             {answer && (
                <div className="absolute bottom-4 right-4 flex items-center gap-1 text-sm text-[#DD8B8B] font-bold bg-white/80 px-3 py-1.5 rounded-md shadow-sm opacity-50 hover:opacity-100 transition-opacity pointer-events-none">
                   <Save size={14} />
    ...
    return (
      <div className="h-full flex flex-col justify-center items-center p-8 lg:p-12 bg-gradient-to-br from-[#FDFBF9] to-[#FFF5F7] overflow-y-auto">
         <div className="max-w-[90%] xl:max-w-7xl 2xl:max-w-screen-2xl w-full flex flex-col items-center text-center gap-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#DD8B8B]/20 text-[#734025] text-sm font-bold uppercase tracking-widest">
               <Sparkles size={16} />
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl 2xl:text-8xl font-black text-[#4A2C2A] tracking-tight leading-tight flex flex-col items-center gap-3">
               ...
               <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#DD8B8B] to-[#dc9942] pb-3">与研发效能管理</span>
            </h1>
            ...
            <div className="w-full max-w-3xl mt-6">
              <motion.div 
                layout
                className={`bg-white border border-[#E8DCC6] rounded-2xl overflow-hidden shadow-sm transition-all ${isHomeContextExpanded ? 'shadow-lg ring-1 ring-[#DD8B8B]/30' : ''}`}
              >
                <div 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mt-16">
               <button 
                  ...
                  className="group flex flex-col gap-5 p-8 bg-white border border-[#E8DCC6] rounded-3xl shadow-sm hover:shadow-xl hover:border-[#DD8B8B]/50 transition-all text-left"
               >
                  <div className="h-12 w-12 rounded-full bg-[#DD8B8B]/20 flex items-center justify-center text-[#734025] group-hover:scale-110 transition-transform">
                     <BookOpen size={24} />
                  </div>
                  <div>
  ...
  return (
    <div className="h-full flex flex-col gap-8 w-full max-w-[96%] 2xl:max-w-[90%] mx-auto p-6 md:p-8 lg:p-10 overflow-y-auto custom-scrollbar bg-[#FDFBF9]">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-[#E8DCC6] pb-6">
          <div>
             <div className="flex items-center gap-3 mb-3">
              <span className="px-3 py-1 bg-[#DD8B8B] text-white text-xs font-bold rounded-full uppercase tracking-wider">
                {post.category}
              </span>
             ...
             <div className="flex gap-2">
               {post.links.map(link => (
                 <a 
                   ...
                   className="flex items-center gap-1.5 text-sm font-bold text-[#734025] bg-[#DD8B8B]/20 px-4 py-2 rounded-full hover:bg-[#DD8B8B]/30 transition-colors"
                 >
        ...
        {/* Viewpoint Card - UPDATED THEME: Pink/Gold Gradient */}
        <div className="w-full bg-gradient-to-r from-[#DD8B8B] to-[#dc9942] rounded-2xl p-8 md:p-10 shadow-lg text-white relative overflow-hidden group">
        ...
        <div className="flex-[3] bg-white border border-[#E8DCC6] rounded-3xl shadow-sm flex flex-col overflow-hidden">
          <div className="px-8 py-5 border-b border-[#E8DCC6] bg-[#FFF5F7]/30 flex items-center justify-between">
            <div className="flex items-center gap-3 text-[#4A2C2A]">
                <BookOpen className="text-[#DD8B8B]" size={20} />
          ...
          <div className="p-8 md:p-10 overflow-y-auto custom-scrollbar flex-1 max-h-[800px] xl:max-h-none markdown-body">
            ...
            <ReactMarkdown
              components={{
                ...
                ul: ({node, ...props}) => <ul className="list-disc pl-6 space-y-3 marker:text-[#DD8B8B] text-[#4A2C2A] text-lg 2xl:text-xl" {...props} />,
                ol: ({node, ...props}) => <ol className="list-decimal pl-6 space-y-3 marker:text-[#DD8B8B] text-[#4A2C2A] text-lg 2xl:text-xl" {...props} />,
                ...
                a: ({node, ...props}) => <a className="text-[#DD8B8B] hover:text-[#dc9942] underline" target="_blank" rel="noopener noreferrer" {...props} />,
        ...
        <div className="flex-[2] flex flex-col gap-4 min-h-[500px] xl:min-h-auto relative z-0">
          ...
          {showPinView && pinLink ? (
            ...
            <div className="bg-[#FDFBF7] border border-[#E8DCC6] rounded-3xl p-1.5 shadow-sm flex-1 flex flex-col relative group overflow-hidden">
             ...
             {/* Header Overlay */}
             <div className="absolute top-6 left-6 z-20 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full flex items-center gap-2 border border-[#E8DCC6] shadow-sm">
              <Camera className="text-[#DD8B8B]" size={16} />
      ...
      <div className="flex flex-col gap-6 pb-12">
        ...
        {/* Takeaway Card */}
        <div className="bg-white border border-[#E8DCC6] border-l-[6px] border-l-[#dc9942] rounded-r-2xl p-8 md:p-10 shadow-sm flex flex-col gap-6 relative group hover:shadow-md transition-shadow w-full">
          <div>
        ...
        {/* Reflection Card */}
        {post.reflection && (
          <div className="bg-white border border-[#E8DCC6] border-l-[6px] border-l-[#734025] rounded-r-2xl p-8 md:p-10 shadow-sm flex flex-col gap-4 hover:shadow-md transition-shadow w-full">
